...
- Migration from raw Covalent fetch to official GoldRush SDK with centralized helpers.
...
- Debug route + verbose logging to identify production failures quickly.
